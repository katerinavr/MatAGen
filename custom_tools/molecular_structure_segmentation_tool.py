...
# image_path = f"C:/Users/kvriz/Desktop/pneumatic/multimodal_data_folder/chemical structures/nmat2272_fig2_a.jpg"
# image = Image.open(image_path)

# segments, bboxes, page = structure_image_segment(image_path)
# print('segments', segments)
# name_boxes, polymer_info  = ocrc_polymer_names(image_path)
# print('name_boxes', name_boxes)
...
# print('decimer_ai_boxes', decimer_ai_boxes)
