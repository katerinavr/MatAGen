from matagen.scraping.pipeline import Pipeline
from matagen.config.settings import OPENAI_API_KEY
from typing import Any, Optional

def html_scraper_tool(pdf_file_path: str, api_key: Optional[str] = OPENAI_API_KEY) -> dict:
    """
