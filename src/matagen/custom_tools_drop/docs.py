...
class LoadDoc:
        ...
        **kwargs are passed to the CSVLoader class.
        ...
        if file_name:
            ...
            if self.type == "html":
                ...
                self.loader = UnstructuredHTMLLoader(file_name)
            if self.type == "pdf":
    ...
    def _check_extension(self, extension: str):
        ...
        """
        supported_extensions = {"pdf", "txt", "md", "csv", "html"}
        if extension in supported_extensions:
            self.type = extension
        elif extension == "xml":
            raise NotImplementedError
        else:
            raise Exception(f"Pneumatic supports {supported_extensions} doc files.")
